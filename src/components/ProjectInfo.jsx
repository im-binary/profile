...
export default function ProjectInfo() {
  return (
    <article css={projectInfoContainer}>
      <h2>프로젝트</h2>
      <div>
        <section onClick={() => window.open(URLs.pongdangToday, "_blank")}>
        ...
        <section onClick={() => window.open(URLs.pongdangWorld, "_blank")}>
          <img src='https://cdn.pixabay.com/photo/2016/01/22/16/59/tiger-1156205_1280.jpg' alt='' />
          <div>
            <p>🏠 React로 구현한 블로그</p>
        ...
        <section onClick={() => window.open(URLs.pongdangDiary, "_blank")}>
          <img src='https://cdn.pixabay.com/photo/2016/01/22/16/59/tiger-1156205_1280.jpg' alt='' />
          <div>
            <p>📓 다이어리</p>
        ...
        <section onClick={() => window.open(URLs.searchJJAL, "_blank")}>
          <img src='https://cdn.pixabay.com/photo/2016/01/22/16/59/tiger-1156205_1280.jpg' alt='' />
          <div>
            <p>📷 Search JJAL</p>
            <p>2022.07.18</p>
